...
export const parisHistoricSites: HistoricSite[] = [
  // Napoleon
  {
    ...
    theme: "both",
    why: "Napoleon's vast red porphyry sarcophagus beneath a golden dome — genuinely moving. Also houses the world's greatest collection of French military history and a dedicated WWII section (fall of France, Resistance, de Gaulle, liberation).",
    timeNeeded: "2–3 hours",
    connects: ["Napoleon Bonaparte", "Napoleon's Military Legacy", "Paris in WWII"],
  },
  {
    id: "arc-triomphe",
    ...
    theme: "both",
    why: "Commissioned by Napoleon in 1806 to honour his Grande Armée. 660 battles and 128 generals are engraved on its walls. The Eternal Flame for the Unknown Soldier burns beneath — re-lit by de Gaulle after liberation in 1944. Walk in his footsteps down the Champs-Élysées.",
    timeNeeded: "1 hour",
    connects: ["Napoleon's Paris", "Liberation of Paris 1944"],
  },
  {
    id: "louvre",
    name: "The Louvre",
    ...
    theme: "napoleon",
    why: "Napoleon transformed this royal palace into the world's greatest museum and filled it with art from his campaigns. The Egyptian Antiquities are directly linked to his 1798 Egyptian expedition.",
    timeNeeded: "Half day minimum",
    connects: ["Napoleon's Paris"],
  },
  {
    id: "vendome",
    name: "Vendôme Column",
    ...
    theme: "napoleon",
    why: "Cast from the bronze of 1,250 cannons captured at Austerlitz. Reliefs spiral up the column depicting the 1805 campaign in detail.",
    timeNeeded: "20 minutes (outdoor)",
    connects: ["Napoleon's Paris", "Napoleon's Military Legacy"],
  },
  {
    id: "pere-lachaise",
    ...
    theme: "both",
    why: "Napoleon created this cemetery in 1804 as one of Paris's first modern public burial grounds. Hauntingly beautiful — graves of Chopin, Oscar Wilde, Jim Morrison, Édith Piaf, and many Resistance fighters.",
    timeNeeded: "2 hours",
    connects: ["Napoleon's Paris", "French Resistance in Paris"],
  },
  {
    id: "ecole-militaire",
    ...
    theme: "napoleon",
    why: "The military academy where Napoleon studied and graduated in 1785 (reportedly in one year instead of three). Still an active military school — exterior viewing only. Right next to Les Invalides and the Champ de Mars.",
    timeNeeded: "20 minutes (exterior)",
  ...
  },
  {
    ...
    theme: "both",
    why: "Napoleon was crowned Emperor here in 1804. Survived WWII because von Choltitz refused to destroy it. After the 2019 fire, restored and reopened December 2024.",
    timeNeeded: "1–2 hours",
    connects: ["Napoleon Bonaparte", "Liberation of Paris 1944"],
  },
  ...
  // WWII
  {
    ...
    theme: "wwii",
    why: "The most important Holocaust memorial in France. Wall of Names (76,000 Jewish deportees from France), Tomb of the Unknown Jewish Martyr, archives, and a powerful museum. Free entry.",
    timeNeeded: "2–3 hours",
    connects: ["German Occupation 1940–1944", "Paris in WWII"],
  },
  {
    id: "vel-dhiv",
    name: "Vel' d'Hiv Memorial",
    address: "8 Boulevard de Grenelle",
    arrondissement: "15th",
    coords: [48.8536, 2.2884],
    theme: "wwii",
    why: "Site of the Vélodrome d'Hiver, where 13,000 Jews were held before deportation in July 1942. Where Chirac gave his 1995 speech acknowledging French responsibility. Simple and powerful.",
    timeNeeded: "30 minutes",
    connects: ["German Occupation 1940–1944"],
  },
  {
    id: "pantheon",
    name: "Panthéon",
    ...
    theme: "wwii",
    why: "Jean Moulin — the great unifier of the French Resistance — rests here. Also Voltaire, Rousseau, Victor Hugo, Marie Curie. Magnificent neoclassical architecture from the 18th century.",
    timeNeeded: "1.5 hours",
    connects: ["French Resistance in Paris"],
  },
  {
    id: "meurice",
    name: "Hôtel Meurice",
    ...
    theme: "wwii",
    why: "Where German military governor General von Choltitz surrendered on August 25, 1944 — sealing Paris's survival. Now a luxury hotel; you can walk past or have a coffee in the lobby bar.",
    timeNeeded: "15 minutes (walk-by)",
    connects: ["Liberation of Paris 1944"],
  },
  {
    id: "hotel-de-ville",
    name: "Hôtel de Ville",
    ...
    theme: "wwii",
    why: "Where de Gaulle gave his famous 'Paris! Paris outraged! Paris broken! Paris martyred! But Paris liberated!' speech on August 25, 1944.",
    timeNeeded: "30 minutes",
    connects: ["Liberation of Paris 1944"],
  },
  {
    ...
    theme: "wwii",
    why: "Where the August 1944 Paris uprising began — Resistance-aligned police seized the building, raised the tricolour, and triggered six days of street fighting.",
    timeNeeded: "15 minutes (exterior)",
    connects: ["Liberation of Paris 1944", "French Resistance in Paris"],
  },
];
