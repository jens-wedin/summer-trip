...
export const towns: Town[] = [
  ...
  // ──────────────────────────────────────────────────────────────
  {
    ...
    name: "Helsingborg",
    country: "Sweden",
    tagline: "The Sound's Sentry",
    visitContext: "Day 14 · Sat 4 July · brief stop on Lund → Stockholm",
    images: [
      { src: "https://images.unsplash.com/photo-1697008740733-7551d74f5e53?w=1600&auto=format&fit=crop&q=80", caption: "Kärnan — the medieval keep." },
      { src: "https://images.unsplash.com/photo-1713502653480-e0fb4afd501e?w=1600&auto=format&fit=crop&q=80", caption: "The Öresund waterfront, looking toward Denmark." },
      { src: "https://images.unsplash.com/photo-1642290172761-a919a8627734?w=1600&auto=format&fit=crop&q=80", caption: "Norra Hamnen at dusk." },
    ],
    history: [
      { title: "Strategic control", body: "For centuries, Helsingborg and Helsingør (Denmark) controlled the Øresund, collecting taxes from passing ships. A frequent site of conflict between Sweden and Denmark." },
      { title: "Danish origins", body: "Like Malmö, Helsingborg was a major Danish city until 1658. Its layout and older buildings still reflect this heritage." },
      { title: "Port of entry", body: "Remains one of Sweden's most important transport hubs and a major port for goods and travellers." },
    ],
    pointsOfInterest: [
      { name: "Kärnan (The Keep)", description: "Last remaining part of the medieval Helsingborg Castle. Climb its towers for a panoramic view of the Øresund and the Danish coast." },
      { name: "Norra Hamnen (North Harbour)", description: "Vibrant waterfront area with modern architecture, cafés, and restaurants. Perfect for a walk." },
      { name: "St. Mary's Church (Mariakyrkan)", description: "Beautiful 14th-century Brick Gothic church, one of the oldest in the city." },
      { name: "Dunkers Kulturhus", description: "Modern cultural center designed by Kim Utzon (son of Jørn Utzon, architect of the Sydney Opera House)." },
      { name: "Sofiero Palace & Gardens", description: "Just north of the city, the former summer residence of the Swedish royal family — famous for its incredible rhododendron gardens." },
    ],
    tips: [
      { name: "Tura!", description: "A unique local tradition: take the ferry to Helsingør (Denmark) and back several times in one evening just to enjoy the food and drinks on board." },
      { name: "Fredriksdal Open-Air Museum", description: "A large museum of historic buildings, gardens, and theatres — a peaceful walk in the city." },
      { name: "Rådhuset (City Hall)", description: "Neo-Gothic masterpiece from 1897 with impressive stained-glass windows and a beautiful courtyard." },
      { name: "Coffee and fika", description: "Helsingborg has an excellent café culture. Try a traditional Swedish fika at one of the historic coffee houses." },
    ],
    deepDive: {
      title: "Helsingborg — The Sound's Sentry",
      intro:
        "Helsingborg sits at the narrowest point of the Öresund — only 4 kilometres from Denmark. For 400 years, this city was a giant cash machine for the Danish Crown.",
      chapters: [
        {
          title: "1. The Key to the Baltic",
          body: [
            "If you wanted to sail from the North Sea into the Baltic Sea, you had to pass through the Öresund. Starting in 1429, the Danish King forced every single ship to stop and pay a toll — the Øresundstolden. If they refused, cannons from Helsingborg and Helsingør (on the other side) would sink them.",
            "This toll was so profitable that it made up two-thirds of Denmark's entire national income at its peak. This is why Sweden and Denmark fought so many wars over this specific spot.",
          ],
        },
        {
          title: "2. Kärnan — The Invincible Keep",
          body: [
            "The 35-metre tower you see today is the only surviving part of a massive medieval fortress. It was the inner keep of the castle. The walls are an incredible 4.5 metres thick.",
            "The upper floors weren't just for soldiers — they were luxury rooms for the King when he visited.",
            "After Sweden finally took the city from Denmark in 1658, the Swedish King ordered the rest of the castle destroyed so the Danes couldn't use it if they ever invaded again. He kept the tower as a landmark for sailors.",
          ],
        },
        {
          title: "3. The Scanian War Bloodbath",
          body: [
            "The worst fighting in Helsingborg's history happened in the late 1600s. Battle of Helsingborg, 1710 — a massive Danish army landed to try and win back the province. The Swedish army met them in a brutal winter battle. Over 5,000 soldiers died in just a few hours. The city was left in ruins.",
          ],
        },
        {
          title: "4. The Tura Tradition",
          body: [
            "Even though the wars are over, the connection across the water is still there. Tura! — a unique local tradition where people take the ferry to Denmark and back several times in one evening, just to enjoy the food and drinks on the boat. A modern, peaceful way to celebrate the history of the Sound.",
          ],
        },
      ],
      lookFor:
        "Climb the 190 steps to the top of Kärnan. On a clear day, you can see the castle of Kronborg in Denmark. These two towers were the jaws that controlled the world's most valuable waterway.",
    },
    relatedDayIds: [13, 14],
  },
];
