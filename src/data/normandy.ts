...
export const bayeuxRestaurants: BayeuxRestaurant[] = [
  { name: "La Rapière", rating: "★ 4.8 · #3 in Bayeux", bib: true, category: "restaurant", note: "Inrymt i en byggnad från 1400-talet. Anses vara Bayeux bästa restaurang. Lunch €16–21, middag €36–49. Boka 1–2 veckor i förväg.", closed: "Söndagskväll & mån" },
  { name: "La Bonbonne", rating: "★ 4.8 · #2 in Bayeux", category: "restaurant", note: "Rue Saint-Jean. Liten meny som byts varje vecka. Bistro till lunch, tearoom på eftermiddagen, dinnerbar på kvällen. Två rätter €17,90, tre rätter €21. Reservering nödvändig.", closed: "Sön & mån" },
  { name: "L'Alcôve", rating: "★ 4.7 · #6 in Bayeux", bib: true, category: "restaurant", note: "Alldeles bakom katedralen. Veckobytande set menus med marknadsfriska och säsongsbetonade råvaror. Ljust, växtfyllt rum. Utmärkt valuta för pengarna." },
  { name: "Le Moulin de la Galette", rating: "★ 4.5 · #14 — Crêperie", category: "restaurant", note: "Inrymt i ett medeltida kvarnhus vid floden — hjulet snurrar fortfarande. Galetter, söta crêpes, normandisk cider. Terrass med utsikt över floden. Bra glutenfria alternativ." },
  { name: "Le Pommier", rating: "★ 4.2 (Google) · 4.0 (TA)", category: "restaurant", note: "Traditionell normandisk mat i en gammal stenbyggnad, katedralsutsikt från terrassen. Starka på lokala skaldjur och säsongsbetonade kötträtter.", closed: "Tis, ons lunch, tor" },
  { name: "Le Garde-Manger (Hôtel Reine Mathilde)", rating: "★ 3.9 (TA)", category: "restaurant", note: "Stenväggar, brasseriestämning, klassiska normandiska rätter. Serverar kontinuerligt 07:00–22:00 varje dag — mest praktisk på turdagen när man äter på udda tider. Ca €20 à la carte." },

  { name: "Reine Mathilde Patisserie", category: "cafe", note: "Hörnet vid katedralen. Utmärkta varma drycker och bakverk till frukost eller eftermiddagskaka. Varmchokladen berömmes." },
  { name: "Les Volets Roses", category: "cafe", note: "Charmigt tearoom på vägen till katedralen. Fransk frukost: kaffe, juice, croissant, bröd. Söndagsbrunch med normandisk ost, quiche och kakor." },
  { name: "Au Louis d'Or", category: "cafe", note: "Centralt beläget. Goda crêpes — och ett bra ställe att prova lokal normandisk cider, den regionala motsvarigheten till vin från äppelodlingarna." },
  { name: "La Maison Lemoisson", category: "cafe", note: "Pålitligt bageri för frukost eller ett litet mellanmål. Värt att plocka med sig en påse bakverk på väg ut till stränderna." },
];
...
export const bayeuxShuttle = {
  date: "Fredag 26 juni 2026",
  ref: "260476",
  departure: "08:45 skarpt · Place de Québec, Bayeux",
  duration: "8,5 timmar",
  passengers: 2,
  totalPrice: "€270 (€135 per person)",
  groupSize: "Maximalt 8 deltagare",
  language: "Endast engelska",
  transport: "Modern luftkonditionerad minibuss",
  sector: "Gold & Omaha (brittisk & amerikansk)",
  ...
  practical: [
    "Upplägget är utformat så att du hinner äta frukost på hotellet först",
    "Kom i god tid — de håller schemat och väntar inte. Ingen återbetalning om du missar avgång.",
    "Gratis parkering nära Bayeux järnvägsstation (10 min promenad till Place de Québec). Ingen gratis parkering vid Place de Québec.",
    "Resplanen kan köras i omvänd ordning beroende på trafiken.",
    "Inget bagage ombord. Inga rullstolar, elscootrar eller rollatorer.",
    "Barn under 4 år accepteras inte på gruppturer. Varje passagerare behöver en bokad plats (ingen knäsittning).",
  ],
  cancellation: "Fri avbokning upp till 24 timmar före. Ingen återbetalning inom 24 timmar. 5 % PayPal-avgift vid återbetalning.",
  stops: [
    { stage: 1, time: "08:45", title: "Mötesplats", location: "Place de Québec, Bayeux", type: "meet" as const, body: "Var på avgångsplatsen minst 10 minuter i förväg. Turen avgår på utsatt tid — ingen väntan." },
    { stage: 2, title: "Normandy British Memorial", location: "Ver-sur-Mer (Gold)", type: "guided" as const, body: "Namnen på alla 22 442 soldater som dog i Normandiestriden utan känd grav. Tre tre meter höga bronsinfanterister av David Williams-Ellis." },
    { stage: 3, title: "Gold Beach", location: "Asnelles", type: "drive-by" as const, body: "Genomfart med kommentarer. De brittiska styrkorna här hade tre mål: inta Arromanches, förena sig med kanadensarna vid Juno, och trycka inåt landet för att ta Bayeux — den första franska stad som befriades, dagen därpå." },
    { stage: 4, title: "Mulberry Harbour B", location: "Arromanches", type: "guided" as const, body: "Resterna av den prefabricerade hamnen — Port Winston — syns fortfarande utanför kusten. De allierade bogserade en hel hamn över Engelska kanalen och monterade ihop den här." },
    { stage: 5, title: "Tyskt Atlantvallsbatteri", location: "Longues-sur-Mer", type: "guided" as const, body: "Det enda Atlantvallsbatteriet i området med sina kanoner fortfarande kvar i ursprungliga kasematter. Hur det byggdes, bemannades, besköt flottan på D-dagen — och hur det tvingades till tystnad." },
    { stage: 6, time: "ca 1 timme", title: "Lunchpaus (ingår ej)", location: "Valfritt: Bayeux eller Port-en-Bessin", type: "lunch" as const, body: "Lunch ingår inte. Ungefär en timme. Snabb lunch endast — inte en lång sittning." },
    { stage: 7, title: "Pointe du Hoc", location: "Klipporna mellan Utah och Omaha", type: "guided" as const, body: "Amerikanska Rangers besteg nästan 30 meter lodräta klippor under eld för att förstöra sex långräckviddiga kanonpositioner. Kratrar, bunkrar och observationsposter lämnade intakta — ett månlandskap fruset i 1944." },
    { stage: 8, title: "Omaha Beach", location: "'Blodiga Omaha'", type: "guided" as const, body: "Promenera på sanden. Höga klipphöjder ovanför kantades av tyska kulsprutor. Guiden beskriver det kort: 'mycket skrämmande'." },
    { stage: 9, title: "Normandy American Cemetery", location: "Colleville-sur-Mer", type: "guided" as const, body: "70 hektar ovanför Omaha. Vandra bland raderna av vita kors och Davidsstjärnor. En av världens mest gripande platser." },
    { stage: 10, time: "ca 17:15", title: "Återresa till Bayeux", location: "Place de Québec, Bayeux", type: "return" as const, body: "Återvänder till samma avgångspunkt — inte hotellen." },
  ],
};
