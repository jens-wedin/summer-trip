...
export const tripWeather: WeatherStop[] = [
  ...
  { dayId: 11, date: "Ons 1 jul", isoDate: "2026-07-01", city: "Roermond", country: "Nederländerna", coords: [51.1942, 5.987], driving: true, climate: { highC: 23, lowC: 13, rainDays: 11, summary: "Limburg — varma dagar vid Roer och Maas." } },
