...
export const trip: Trip = {
  ...
  days: [
    ...
    },
    {
      ...
      resources: [
        { title: "La Madeleine", url: "https://maps.app.goo.gl/ZhRUWY4rdW1L1MSf6" },
        { title: "Lavatory Madeleine — Paris första offentliga toalett (1905)", url: "https://en.wikipedia.org/wiki/Lavatory_Madeleine" },
        { title: "Picchetto — lunch", url: "https://maps.app.goo.gl/kZDhfjtNgDsGDeLW9" },
        { title: "Napoleons grav · Les Invalides", url: "https://maps.app.goo.gl/aEVgLcjFhRvRyVQW8" },
        { title: "Aux Crus de Bourgogne — middag", url: "https://maps.app.goo.gl/EeDwj4Rn9MUytcdn8" },
      ],
      enRouteStops: [
        { name: "La Madeleine", description: "Napoleons tempellika kyrka — och strax intill Paris första offentliga toalett från 1905." },
        { name: "Place de la Concorde", description: "Den stora platsen med obelisken, på väg ner mot Seine." },
        { name: "Eiffeltornet", description: "Tunnelbana till École Militaire och en titt på tornet." },
        { name: "Lunch på Picchetto", description: "En delad burrata och en pizza." },
        { name: "Les Invalides", description: "Napoleons grav, Musée de l'Armée och Musée de l'Ordre de la Libération — massor av fransk historia och vapen, avrundat med en drink utanför." },
        { name: "Galeries Lafayette", description: "Sara och Elsa på shoppingdag vid Haussmann — det blev konst och ringar." },
        { name: "Aux Crus de Bourgogne", description: "Klassisk fransk middag; sedan Frankrike–Sverige på en bar." },
      ],
      story: [
        "Sista dagen i Paris. Nelson och jag ägnade morgonen åt Napoleons fotspår: först La Madeleine, den tempellika kyrkan — och strax intill Paris första offentliga toalett från 1905. Vidare ner till Place de la Concorde och sedan tunnelbana till École Militaire för en titt på Eiffeltornet.",
        "Lunch blev en delad burrata och en pizza på Picchetto. På eftermiddagen gick vi till Les Invalides — Napoleons grav, Musée de l'Armée och Musée de l'Ordre de la Libération. Massor av fransk historia och vapen, avrundat med en drink utanför museerna. Sara och Elsa hade under tiden en shoppingdag på Galeries Lafayette och kom hem med konst och ringar.",
    ...
    },
    {
      ...
      date: "onsdag 1 juli",
      weekday: "onsdag",
      title: "Slagfältet vid Waterloo",
      kicker: "Dag 11 · Paris → Roermond (via Waterloo)",
      from: { id: "paris", name: "Paris", country: "Frankrike", coords: [48.8566, 2.3522] },
      to: { id: "roermond", name: "Roermond", country: "Nederländerna", coords: [51.1942, 5.987] },
      waypoints: [
        { id: "waterloo", name: "Waterloo", country: "Belgien", coords: [50.6803, 4.4062] },
      ],
      drivingKm: 460,
      drivingDuration: "5h 00m",
      driveNote:
        "Waterloo som dagsstopp (museum och slagfält, ~2 t 50 min från Paris), sedan vidare till Roermond i Nederländerna för natten.",
      lodging: {
        name: "De Pastorie Bed & Breakfast",
        address: "Roermond, Nederländerna",
        url: "https://maps.app.goo.gl/E5wpV5WBU4UDBYdV6",
        dates: "1–2 juli",
        description:
          "Charmigt B&B med egen chocolaterie i Roermonds gamla stad.",
        status: "booked",
      },
      charging: {
        note: "Snabbladdning i Belgien på vägen; Roermond ligger strax över nederländska gränsen.",
        stops: [],
      },
      enRouteStops: [
        { name: "Waterloo", description: "Slagfältet där Napoleon besegrades 1815 — ett fint museum och den historiska marken, med Lejonkullen resande sig över fälten." },
        { name: "Roermond", description: "Kväll i Roermond i Nederländerna: incheckning på De Pastorie B&B och middag på en indisk restaurang." },
      ],
      story: [
        "Dags att lämna Paris. Nästa anhalt blev Waterloo — fortfarande i Napoleons fotspår. Ett fint museum och den historiska marken där slaget stod 1815, med Lejonkullen som reser sig över fälten.",
    ...
    },
    {
      ...
      kicker: "Dag 12 · Roermond → Lübeck",
      from: { id: "roermond", name: "Roermond", country: "Nederländerna", coords: [51.1942, 5.987] },
      ...
      drivingKm: 540,
      drivingDuration: "5h 15m",
      driveNote: "Lång transportsträcka norrut genom Tyskland — förbi Bremen och Hamburg till Lübeck.",
      lodging: {
      ...
      enRouteStops: [
        { name: "Autobahn norrut", description: "Mest transport: genom Tyskland förbi Bremen och Hamburg upp till Lübeck." },
      ],
      story: [
        "Dag tolv blev mest en lång körning norrut till Lübeck. Jens var fortfarande krasslig, så det fick bli en stillsam dag på vägen — autobahn förbi Bremen och Hamburg.",
